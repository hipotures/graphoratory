...
- default --max-uphill 0 permits improvements and neutral moves but no worsening,
...
Set --max-uphill 1 or 2 later if a strict/non-worsening search gets trapped and
you want bounded escapes from a local minimum.

Recommended first run:

    uv run python scripts/heg_fixed_order_polish.py \
      --preset rewire2-n26 \
      --beam-width 32 \
      --max-depth 30 \
      --step-seconds 120 \
