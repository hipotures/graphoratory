...
def score_root(graph: Graph, witness_cap: int, node_budget: int) -> ExactEntry:
...
def update_reservoir(
    ...
    *,
    ...
    if len(reservoir) < capacity:
        ...
        return
    slot = rng.randrange(seen_unique)
    if slot < capacity:
...
def main() -> int:
    ...
    metadata: dict[str, object] = {
        "kind": "cycle_blind_random_legal_walk_cascade_budget",
        "order": root.order,
    ...
    with ProcessPoolExecutor(
        ...
        while evaluated < args.evaluation_budget:
            ...
            for result in round_results:
                ...
                # RANDOM reservoir is deliberately score-blind.  Keep any
                # unique legal candidate, including safely-pruned/nonexact ones.
                update_reservoir(
                    reservoir,
            ...
            if (
                ...
                console.print(
                    ...
                    f"unique={seen_unique:,} dup={duplicates:,} errors={errors:,}"
                )
                console.print(
